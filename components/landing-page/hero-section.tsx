      ...
      >
        ...
        >
          <div className="flex justify-between items-center font-mono text-[10.5px] text-muted-foreground">
            ...
            <span>
              suggested{" "}
              <strong className="text-foreground font-medium">$6</strong>
            </span>
          </div>
          <h4 className="mt-3 text-base font-semibold tracking-tight leading-snug text-foreground">
            Postgres Performance Field Notes
          </h4>
          <p className="mt-1.5 text-[12.5px] text-muted-foreground leading-relaxed">
            Indexing, query plans, and the gotchas nobody warns you about.
          </p>
          <div className="mt-[15px] h-[38px] grid place-items-center rounded-[9px] border border-border bg-background text-[13px] font-medium">
            Select
          </div>
        </motion.div>
        ...
        >
          <div className="flex justify-between items-center font-mono text-[10.5px] text-muted-foreground">
            ...
            <span>
              suggested{" "}
              <strong className="text-foreground font-medium">$12</strong>
            </span>
          </div>
          <h4 className="mt-3 text-base font-semibold tracking-tight leading-snug text-foreground">
          ...
          <p className="mt-1.5 text-[12.5px] text-muted-foreground leading-relaxed">
            From tokens to components — a practical build order.
          </p>
          <div className="mt-[15px] h-[38px] grid place-items-center rounded-[9px] border border-border bg-background text-[13px] font-medium">
            Select
          </div>
        ...
        >
          <p className="font-mono text-[10.5px] text-muted-foreground tracking-[0.08em]">
            PLAYBOOK
          </p>
          <p className="mt-2 text-[19px] font-semibold tracking-tight text-foreground">
            The SaaS Pricing Playbook
          </p>
          ...
          <p className="mt-0.5 font-mono text-[11px] text-muted-foreground">
            Suggested price:{" "}
            <strong className="text-foreground font-medium">$9.00</strong>
          </p>
          <div className="mt-[11px] flex items-center rounded-[10px] border border-border bg-background overflow-hidden">
            <div className="w-[42px] self-stretch grid place-items-center border-r border-border bg-muted font-mono text-[15px] text-muted-foreground">
              $
            </div>
      ...
      >
        <motion.div variants={heroCopy}>
          ...
          <h1 className="mt-[22px] text-[clamp(44px,6.6vw,88px)] font-medium leading-[0.96] tracking-[-0.045em] text-foreground [text-wrap:balance] max-sm:text-[40px]">
            Pay what you think{" "}
            <span className="text-primary">it&rsquo;s worth.</span>
          </h1>
          <p className="mt-[26px] text-[clamp(16.5px,1.3vw,19px)] leading-[1.55] text-muted-foreground max-w-[44ch] [text-wrap:pretty] max-sm:text-[15.5px]">
            Choose a document, enter any amount greater than&nbsp;$0, and unlock
            the download. Secure Stripe checkout, no upsells.
          </p>
          <div className="mt-9 flex flex-wrap items-center gap-x-[22px] gap-y-4 max-sm:mt-7">
            <Button
              size="lg"
              className="h-[52px] rounded-[11px] px-6 text-[15.5px] max-sm:w-full"
              asChild
            >
              <Link href="/documents">
